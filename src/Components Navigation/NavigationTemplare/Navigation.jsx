import Nav from "../NavlcomTemplare/Nav"
    ...
    return (
        <div className={`Navigation ${nav && "active"} ${DarkTheme && "dark"}`}>
            ...
            onClick={() =>{
                ...
                <FiChevronLeft className="menu" />
            </div>
            <header>
                <div className="profile">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbYE9px22HMtGqsmd6v-p9pQN_N9ZDbJaCOQ&usqp=CAU" alt="user-img" className="profile-img" />
                </div>
                <span>creativ_ambitation</span>
            </header>
